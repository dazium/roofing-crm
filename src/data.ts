...
export const seedData: AppData = {
  ...
  invoices: [{ id: 'inv-1', jobId: 'job-2', invoiceNumber: 'RTR-INV-2001', amount: 4746, paidAmount: 1500, balanceDue: 3246, status: 'Partial', dueDate: '2026-03-31', issuedDate: '2026-03-24', notes: 'Deposit received. Balance due on completion.' }],
