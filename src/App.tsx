  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { key: 'crew-mode', label: 'Subcontractor Operations', icon: <HardHat size={18} /> },
        { key: 'customers', label: 'Companies & Accounts', count: data.customers.length, icon: <Users size={18} /> },
        { key: 'jobs', label: 'Work Orders', count: data.jobs.length, icon: <KanbanSquare size={18} /> },
        { key: 'crew-mode', label: 'Field Crew Mode', icon: <HardHat size={18} /> },
        { key: 'customers', label: 'Direct Customers', count: data.customers.length, icon: <Users size={18} /> },
        ...
        { key: 'inspect', label: 'Inspections', icon: <Camera size={18} /> },
        { key: 'invoices', label: 'Invoices', count: data.invoices.length, icon: <FileSignature size={18} /> },
        { key: 'invoices', label: 'Invoice Templates', icon: <FileText size={18} /> },
        { key: 'reports', label: 'Financial Dashboard', count: data.invoices.length, icon: <BarChart3 size={18} /> },
        { key: 'reports', label: 'Financial Reports', icon: <ChartNoAxesCombined size={18} /> },
        ...
        { key: 'timesheets', label: 'Crew Productivity', icon: <Clock3 size={18} /> },
      ],
    },
  ];
