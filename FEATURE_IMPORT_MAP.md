...
| **Materials Pricing** | Dynamic pricing feeds/catalogs. | Keep local material price table plus desktop scraper refresh; no central pricing service. | ✅ KEEP / 💡 ADAPT | Damage material allocations now aggregate into estimate line items. Material category taxonomy and legacy normalization were added on 2026-05-27. |
...
| **Calendar / Routing View** | Advanced resource scheduling, map view, route ordering. | Compatible when implemented as local customer/job/appointment sorting and Google Maps handoff. | ✅ KEEP / 💡 ADAPT | Locations route exists; route queue now supports active-first, schedule, and crew ordering. |
| **Invoice Email Workflow** | Server-side email delivery and HTML templates. | Use local mail client handoff for v1; avoid SMTP/service dependency. | ✅ KEEP / 💡 ADAPT | Invoice delivery, reminder, and overdue templates added with invoice history logging. |
